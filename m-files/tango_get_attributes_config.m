function attr_config_list = tango_get_attributes_config (dev_name, attr_list)
%TANGO_GET_ATTRIBUTES_CONFIG Query a device for information about several attributes.
%
% Syntax:
% -------
%   attr_config_list = tango_get_attributes_config(dev_name, attr_list)
%
% Argin: dev_name 
% ---------------
...
%   |- desc: the name of the attributes
%
% Argout: attr_info
% -----------------
...
%   %- get attributes info
%   attr_info_list = tango_get_attribute_config('dev', attr_list);
%   %- always check error
%   if (tango_error == -1)
%     %- handle error
...
%   end
%   
%   See also TANGO_GET_ATTRIBUTE_CONFIG, TANGO_ATTRIBUTE_QUERY, TANGO_COMMAND_LIST_QUERY

% TANGO_GET_ATTRIBUTE_CONFIG cmd-id :15
attr_config_list = tango_binding(int16(15), dev_name, attr_list);
return;